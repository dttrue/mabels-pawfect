...
export default function ThanksgivingSpecials({
  ...
  imageSrc = "/images/seasonal-pricing/fall-thanksgiving-pricing-2025.jpg",
}) {
  const handlePricingClick = () => {
    trackPricingCTA({
      page: "homepage",
      location: "thanksgiving_specials",
    });
  };
  ...
  const handleFlyerClick = () => {
    trackPricingCTA({
      page: "homepage",
      location: "thanksgiving_specials_flyer",
    });
  };
        ...
        <div className="relative">
          <div className="rounded-xl border border-white/10 bg-[#1b120a] p-2 shadow-sm">
            <Link
              ...
              aria-label="Open Thanksgiving pricing"
            >
              <Image
                src={imageSrc}
