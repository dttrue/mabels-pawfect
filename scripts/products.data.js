...
const PRODUCTS = [
  // ---------- DOG ----------
  {
    ...
    description: "Toasty winter vibes! Soft plush with an internal squeaker—perfect for gentle play and quick zoomies.",
    priceCents: 799,
  ...
  },
  {
    ...
    description: "Bring the holiday cheer! A soft wreath toy with crinkles/squeaks to keep the party going.",
    priceCents: 799,
    categories: ["dog", "holiday", "plush"],
    images: [],
  },
  {
    ...
    description: "A big, cuddly candy cane plush for tug, toss, and seasonal photos. Squeaks included.",
    priceCents: 1199,
    categories: ["dog", "holiday", "plush"],
    images: [],
  },
  {
    ...
    description: "Light, squeaky, and adorable—this poodle pops with personality. Great for small to medium pups.",
    priceCents: 799,
  ...
  },
  {
    ...
    description: "Milk + two cookies—three squeaky plushies for variety and festive fetch.",
    priceCents: 1299,
  ...
  },
  {
    ...
    description: "Classic KONG comfort with a seasonal twist. Gentle, cozy, and perfect for downtime snuggles.",
    priceCents: 999,
    categories: ["dog", "holiday", "plush"],
    images: [],
  },
  {
    ...
    description: "The iconic Lamb Chop with a squeaker. Soft, nostalgic, and photo-ready.",
    priceCents: 1299,
    categories: ["dog", "plush"],
    images: [],
  },
  {
    ...
    description: "The fan-favorite loofa shape—easy to grab and perfect for a shake. Colors vary.",
    priceCents: 525,
    categories: ["dog", "plush"],
    images: [],
  },
  {
    ...
    description: "Tougher play in a smaller ring. Great for fetch, tug, and chewers-in-training.",
    priceCents: 1299,
  ...
  },
  {
    ...
    description: "A festive mat with multiple squeakers—satisfying crunch with every pounce.",
    priceCents: 1099,
  ...
  },
  {
    ...
    description: "Interactive puzzle play: stuff the minis in the tree and let your pup ‘dig’ them out.",
    priceCents: 1499,
  ...
  },
  {
    ...
    description: "No stuffing, all squeak. Sweet seasonal donut that’s perfect for light chewers.",
    priceCents: 799,
    categories: ["dog", "holiday", "plush"],
    images: [],
  },
  ...
  // ---------- CAT ----------
  {
    ...
    description: "A fanciful merlot bottle stuffed with catnip for classy zooms and bunny kicks.",
    priceCents: 400,
  ...
  },
  {
    ...
    description: "Mini birds in a soft nest—paw, pull, repeat. Engaging enrichment for curious kitties.",
    priceCents: 999,
  ...
  },
  {
    ...
    description: "Cute cones with a dash of catnip. Assorted colors; perfect size for swats and carries.",
    priceCents: 300,
  ...
  },
  {
    ...
    description: "A slice of fun—lightweight, crinkly, and catnip-kissed. Assorted styles.",
    priceCents: 250,
    categories: ["cat", "plush"],
    images: [],
  },
  {
    ...
    description: "Simple, satisfying rolling fun. Bat it, chase it, nap on it—cat rules apply.",
    priceCents: 400,
  ...
  },
  {
    ...
    description: "Crinkly ‘candy’ with fluttery feathers—irresistible for swats and pounces.",
    priceCents: 250,
    categories: ["cat", "interactive", "plush"],
    images: [],
  },
  {
    ...
    description: "A fluttery butterfly on a wand for active play and healthy leaps.",
    priceCents: 450,
    categories: ["cat", "interactive"],
    images: [],
  },
  {
    ...
    description: "Mountable swat toy to keep paws busy. Great for solo batting sessions.",
    priceCents: 1299,
    categories: ["cat", "interactive"],
    images: [],
  },
  {
    ...
    description: "Soft kickers with seasonal flair. Perfect for bunny kicks and cuddle naps.",
    priceCents: 699,
  ...
  },
  {
    ...
    description: "Tiny seasonal toys for swats, carries, and pitter-patter sprints.",
    priceCents: 350,
    categories: ["cat", "holiday", "plush"],
    images: [],
  },
  {
    ...
    description: "A playful duo for the ‘sometimes nice’ kitty. Photo-worthy and fun.",
    priceCents: 600,
  ...
  },
  {
    ...
    description: "A trio of plush mini donuts—paw-sized and perfect for batting practice.",
    priceCents: 799,
