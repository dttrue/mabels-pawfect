 ...
 const services = [
   {
     ...
     icon: "🐕",
     price: "15 min: $15, 30 min: $22, 1 hour: $30",
   },
   {
     title: "Pet Sitting",
   ...
   },
   {
     ...
     price:
       "🐶 Dogs:\n" +
       "• 1 dog: 15 min $20, 30 min $25, 1 hr $30\n" +
       "• 2 dogs: 15 min $22, 30 min $30, 1 hr $35\n\n" +
       "🐱 Cats:\n" +
       "• 1 cat: 15 min $10, 30 min $20, 1 hr $25\n" +
       "• 2 cats: 15 min $20, 30 min $22, 1 hr $28",
   },
   {
     title: "Pet Care",
     description:
